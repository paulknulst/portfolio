                    ...
                    <div className="mt-6 text-gray-800 dark:text-white">
                        <p className="mb-4">I'm a Tech Lead and
                            Technical Writer. I work as a Team Lead at <a
                                ...
                                rel="noreferrer">Realcore.</a>
                        </p>
                        <p className="mb-4">Currently developing apps on React, Nest, Express, Android, AWS, GCP and
                            writing articles on Medium in my free time about challenges in IT. New to Next.js,
                            Tailwindcss and
                            Canva/Figma.
                        </p>
